...
public class DataManager : MonoBehaviour
{
    ...
    public Dictionary<string, Items> itemDict;
    [SerializeField]
    ...
    void Awake()
    {
        if (instance == null)
        {
            ...
            Items[] allitems = Resources.FindObjectsOfTypeAll<Items>();
            itemDict = new Dictionary<string, Items>();
    ...
    public void LoadGameData()
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            {
                itemDict.TryGetValue(item.templateName, out item.items);
            }
            itemDict.TryGetValue(gameData.weapon?.templateName, out gameData.weapon.items);
            HookGameData();
        }
        else
        {
    ...
    private void UpdateGamedata()
    {
        ...
        if (PlayerInventory.instance.weapon?.items == null)
